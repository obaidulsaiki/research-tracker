...
@Component
public class SpringerScraper extends BaseScraper {

    @Override
    public boolean supports(String url) {
        return url.contains("springer.com") || url.contains("link.springer.com") || url.contains("nature.com");
    }
    ...
    public JournalMetadataDTO scrape(String url, String journalName) {
        try {
            ...
            return JournalMetadataDTO.builder()
                    ...
                    .impactFactor(extractMetric(doc, "Impact Factor", "2-year Impact Factor"))
